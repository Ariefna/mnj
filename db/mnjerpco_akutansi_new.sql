...
--
-- Host: localhost
-- Generation Time: May 17, 2021 at 05:17 AM
...
(1, 2344676557, 13, 1, 100000, 'Sudah Dibayarkan');
...
(1, 'Super admin', 'admin', '21232f297a57a5a743894a0e4a801fc3', '2021-05-17 02:29:52', 1),
...
--
ALTER TABLE `detail_bpjs`
  MODIFY `id_detail_bpjs` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2;

--
-- AUTO_INCREMENT for table `detail_karyawan`
--
ALTER TABLE `detail_karyawan`
  MODIFY `id_detail_karyawan` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2;
