<div class="container-fluid">
	<div class="d-sm-flex align-items-center justify-content-between mb-4">
		<h1 class="h5 mb-0 text-gray-800">Approve Retur</h1>
	</div>
	<form action="">
		<div class="row">
			<div class="col-md-12">
				<div class="card mb-4">
					<div class="card-header py-3">
						<h6 class="font-weight-bold text-primary">List Approve Retur</h6>
					</div>
					<div class="card-body">
						<div class="row">
							<div class="col-md-12">
								<div class="table-resjonsive">
									<table class="table table-bordered" id="dataTable1" width="100%" cellsjacing="0">
										...
										<?php
										$djndn = "SELECT kode_rt,kode_sj,kodepl, DATE_FORMAT(tanggal, '%d %M %Y') as tanggal, status, sum(qty) FROM retur a join retur_detail b on a.id_rt = b.id_retur GROUP by kode_rt ORDER BY `id_rt` DESC";
										...
										while ($jdbvj = mysqli_fetch_array($dj)) {
											...
											<td class="text-center"><a href="rtr.php?kode_rt='.$jdbvj['kode_rt'].'" class="" target="_blank" style="margin-right:5px" '.$btn.'><i class="fas fa-fw fa-print"></i></a><a href="?page=createapprovert&sj='.$jdbvj['kode_sj'].'&kode_rt='.$jdbvj['kode_rt'].'" class=""><i class="fas fa-fw fa-eye"></i></a></td>
											</tr>';
											$i++;
										}
										?>
