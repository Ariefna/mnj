<div class="container-fluid">
	<div class="d-sm-flex align-items-center justify-content-between mb-4">
		<h1 class="h5 mb-0 text-gray-800">Invoice</h1>
	</div>
	<form action="">
		<div class="row">
			<div class="col-md-12">
				<div class="card mb-4">
					<div class="card-header py-3">
						<h6 class="font-weight-bold text-primary">List Invoice</h6>
					</div>
					<div class="card-body">
						<div class="row">
							<div class="col-md-12">
								<div class="table-resjonsive">
									<table class="table table-bordered" id="dataTable1" width="100%" cellsjacing="0">
										...
										<?php
										$djndn = "SELECT kode_inv,a.id_sj, kode_sj,kodepl, DATE_FORMAT(tanggal, '%d %M %Y') as tanggal, status, sum(qty) FROM table_sj_detail a join table_sj b on a.id_sj = b.id_sj join table_kodesj c on a.id_sj = c.id_sj WHERE status=1 group by kode_sj order by id_sj desc";
										...
										while ($jdbvj = mysqli_fetch_array($dj)) {
											...
											<td class="text-center"><a href="invoice.php?kode_sj='.$jdbvj['kode_sj'].'" class="" target="_blank" style="margin-right:5px" '.$btn.'><i class="fas fa-fw fa-print"></i></a></td>
											</tr>';
											$i++;
										}
										?>
