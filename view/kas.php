...
<div class="container-fluid">
  <div class="d-sm-flex align-items-center justify-content-between mb-4">
    <h1 class="h5 mb-0 text-gray-800">Master Kas</h1>
  </div>
  <div class="row">
    <div class="col-md-4">
      <div class="card  ">
        <div class="card-header py-3">
          <h6 class="font-weight-bold text-primary">Input Master Kas</h6>
        </div>
        <div class="card-body">
    ...
    <div class="col-md-8">
      <div class="card mb-4">
        <div class="card-header py-3">
          <h6 class="font-weight-bold text-primary">List Master Kas</h6>
        </div>
        <div class="card-body">
          <div class="table-responsive">
            <table class="table table-bordered" id="dataTable1" width="100%" cellspacing="0">
              ...
              <tfoot>
                <tr>
                  <?php $total = mysqli_fetch_array(select_tabel_master_hitung($conn, 'kas')); ?>
              ...
              <tbody>
                <?php
                $result = select_tabel_master($conn, 'kas');
